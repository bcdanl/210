...
t1 = tickets.copy()  # Make a NEW list with the same items (a separate object in memory).
                     # Why? If we later change t1 (e.g., t1.append("E") or t1[0] = "Z"),
                     # tickets will NOT change. Without .copy(), both names could refer
                     # to the same list and edits would affect both.
...
for i in range(len(exercises)):
    ...
    # If m > avg is True, label becomes "Above Avg"; otherwise it becomes "Below Avg".
    # Same as:
    # if m > avg:
    #     label = "Above Avg"
    # else:
