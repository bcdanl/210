...
- Please submit your **Jupyter Notebook** for **Part 1 and Part 2 in Homework 2** to Brightspace with the name below:
...
## Question 1
Select "First_Name", "Last_Name", "Base_Salary", and "Total_OT_Paid", then sort the DataFrame with these selected variables by "Base Salary" in descending order and display the top 10 entries.
...
<p align="center">
  <img src="https://bcdanl.github.io/lec_figs/trashwheel.png" width="300px">
</p>
...
DT::datatable(trashwheel_long) 
```


<br><br><br>

# Part 4. Quarto Blogging
