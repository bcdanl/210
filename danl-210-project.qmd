...
- Below are the key components in the data analysis 
  ...
  3. **Data Collection**: Provide the code and the comment on how to retrieve financial, accounting, and ESG data using Python `yfinance` and `selenium`.
     - When providing the code for data collection in your webpage, do not execute the code but to display them only. You can do this by adding `#| echo: true` and `#| eval: false` at the first and the second line in the code chunk for data collection.
