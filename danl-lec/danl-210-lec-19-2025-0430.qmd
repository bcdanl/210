...
<p align="center">
  <img src="https://bcdanl.github.io/lec_figs/pandas-group.png" width="500">
</p>
...
-	The `DataFrame.groupby()` method creates a `DataFrameGroupBy` object that facilitates split-apply-combine operations:
	...
	-	**Apply** functions independently to each group (e.g., calculate sums, averages, or custom metrics).
...
Some built‑in function cannot be directly passed to `agg()`. We can then supply a `lambda` function that receives a **Series** and returns a single value:
