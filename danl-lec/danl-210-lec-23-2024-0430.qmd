...
- Here are the web-link and steps to do so:
  1. Go to [myGeneseo.edu](https://my.geneseo.edu/dashboard)
  2. Click the KnightWeb
  3. Click on the "Surveys" option
  4. Choose DANL 210 (class for which you want to fill out the SCE) and then complete the SCE survey.
