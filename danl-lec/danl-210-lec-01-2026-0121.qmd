...
- A Python script (`*.py`) is a plain-text file that contains Python code you can run from your computer (or an IDE like Spyder).
  ...
  - Scripts are easy to **version-control** with Git/GitHub and are commonly used in real-world analytics and software projects.
...
- **Why Markdown is widely used on the internet:**
  - **Works everywhere:** supported by many platforms, including **Jupyter Notebook**, **GitHub**, **Reddit**, **Slack/Discord**, and documentation websites.
