...
- **command/control + return**: Run cell
...
- A function can take inputs (**arguments**) and return an output.
- Built-in examples: `len()`, `max()`, `sum()`, `type()`
...
-	To call a function, write its name followed by parentheses: `function_name(...)`.
-	Inside the parentheses, you provide inputs called **arguments**, separated by commas.
-	A **parameter** is the name used in the function definition for an expected input (e.g., `sep`).
-	A **default argument** is the value used automatically when you do not supply that argument (e.g., `sep=" "` is the default for `print()`).
