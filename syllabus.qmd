...
| --- | --- | --- | --- |
| 1–3 | Python Fundamentals | HW 1 | Feb 11 |
...
You are provided with 7 unexcused absences per semester. Any additional unexcused absences will be subject to reducing Total Percentage Grade by one percentage point for each additional absence (6 total absences = 1% point (90 to 89), 7 total absences = 2% points (90 to 88), etc.)
