---
title: Classwork 1
subtitle: Building a Personal Website using Git, GitHub, and RStudio
date: last-modified
...
```
  ...
  - Paste your PAT to the RStudio Console, and hit *Enter*.
...
###  Establishing the Connection between GitHub repo and your Git
...
:::{.callout-note}
Instead of Step 7 above, we can follow Steps 7-1 and 7-2. For those who have errors in Step 7, do Steps 7-1 and 7-2 instead. 
:::
...
**Step 8**. Download the files of website template:
  ...
  5. Move all the files that were compressed in the ZIP file to your local project directory.
...
**Step 8**. Push the files to your GitHub repository
  ...
  - On Terminal within RStudio, execute the following 3-step `git` commands, which will *stage*, *commit*, and *push* all the new files in the local working directory to your GitHub repository:
